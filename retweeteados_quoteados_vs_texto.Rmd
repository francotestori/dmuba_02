...
print(trans2)
rules = apriori(trans2, parameter=list(target="rule", support=0.001, confidence=0.02, minlen=2), appearance = list(rhs = 'rt=muchos'))
print(rules)
...
inspect(subset(rules, subset = lhs  %pin% "word=u"))

